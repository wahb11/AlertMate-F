              ...
              children: [
                ...
                TextFormField(
                  decoration: const InputDecoration(
                    ...
                    hintText: 'ABC-1234',
                    helperText: 'Format: ABC-1234 (3 letters, dash, 4 digits)',
                  ),
                  ...
                  validator: (value) {
                    ...
                    // Validate format: ABC-1234 (3 letters, dash, 4 digits)
...
Widget _buildFleetOverview() {
    ...
    vehicle.type.toLowerCase().contains(_searchController.text.toLowerCase()) ||
    ...
    '${vehicle.make} ${vehicle.model}'.toLowerCase().contains(_searchController.text.toLowerCase());
        ...
        return Container(
          ...
          child: Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              // First row: Status and Type dropdowns
              Row(
                children: [
                  Container(
                ...
                child: TextField(
                  ...
                  decoration: InputDecoration(
                    ...
                    focusedBorder: OutlineInputBorder(
                      borderRadius: BorderRadius.circular(8),
                      borderSide: const BorderSide(color: Color(0xFFE2A9F1), width: 2),
                    ),
                ...
                Center(
                  child: Padding(
                    ...
                    child: Column(
                      children: [
                        Icon(
                          _searchController.text.isNotEmpty || _statusFilter != 'All Status' || _typeFilter != 'All Types'
                              ? Icons.search_off
                              : Icons.directions_car_outlined,
                          size: isMobile ? 40 : 48,
                            ...
                            children: [
                              TableRow(
                                ...
                                children: [
                                  ...
                                  _buildTableHeader('Type', isMobile),
      ...
      child: Row(
        ...
        children: [
          ...
          if (methods.contains('sms'))
            Icon(Icons.message, size: isMobile ? 16 : 18, color: const Color(0xFFE2A9F1)),
  ...
  TableRow _buildVehicleRow(Vehicle vehicle, [bool isMobile = false]) {
    return TableRow(
      children: [
        ...
        _buildTableCell(vehicle.type, isMobile),
...
// Custom formatter for License Plate (ABC-1234 format)
class _LicensePlateFormatter extends TextInputFormatter {
  ...
  TextEditingValue formatEditUpdate(
    ...
    for (int i = 0; i < cleanText.length; i++) {
      ...
      // After dash, only digits allowed (up to 4 digits)
      else if (i < 8) {
        if (RegExp(r'[0-9]').hasMatch(char)) {
          buffer.write(char);
        }
