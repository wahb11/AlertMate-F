...
class _AdminDashboardState extends State<AdminDashboard> with TickerProviderStateMixin {
                      ...
                      ? Column(
                          ...
                          children: [
                            ...
                            DropdownButtonFormField<String>(
                              ...
                              items: ['All Roles', 'Admin', 'Driver', 'Passenger', 'Vehicle Owner']
  ...
  Widget _buildRoleBadge(String role) {
    final colors = {
      ...
      'owner': const Color(0xFFE2A9F1),
      'admin': const Color(0xFF9C27B0),
    };

    // Map role to display text
    final displayText = role == 'owner' ? 'Vehicle Owner' : role;
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          _buildRoleRow('Vehicle Owners', 156, const Color(0xFFE2A9F1)),
