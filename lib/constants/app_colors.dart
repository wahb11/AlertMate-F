...
class AppColors {
  // Primary Colors
  static const Color primary = Color(0xFFE2A9F1); // Light lavender
  static const Color primaryLight = Color(0xFFF5E6FA); // Light lavender light
  static const Color primaryDark = Color(0xFFD18FE8); // Light lavender dark
  ...
  static const Color info = Color(0xFFE2A9F1);
  ...
  static const Color police = Color(0xFFE2A9F1);
  static const Color policeLight = Color(0xFFF5E6FA);
