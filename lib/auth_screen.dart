        ...
        content: Column(
          ...
          children: [
            ...
            Container(
              ...
              child: Row(
                children: [
                  Icon(Icons.info_outline, color: const Color(0xFFE2A9F1), size: 20),
                  const SizedBox(width: 8),
                  Expanded(
                    child: Text(
                      'Please verify your email to continue.',
                      style: TextStyle(fontSize: 12, color: const Color(0xFFE2A9F1)),
                    ),
                  ),
                ],
              ),
        ...
        child: Column(
          children: [
            AnimatedContainer(
              ...
              height: 64,
              decoration: BoxDecoration(
                color: isActive ? const Color(0xFFF5E6FA) : Colors.white,
                ...
                boxShadow: isActive
                    ? [
                        BoxShadow(
                          color: const Color(0xFFE2A9F1).withValues(alpha: 0.3),
                          blurRadius: 8,
                          offset: const Offset(0, 4),
                        ),
                      ]
    ...
    return GestureDetector(
      ...
      child: AnimatedScale(
        ...
        child: AnimatedContainer(
          ...
          decoration: BoxDecoration(
            color: isActive ? const Color(0xFFF5E6FA) : Colors.transparent,
            borderRadius: BorderRadius.circular(8),
            boxShadow: isActive
                ? [
                    BoxShadow(
                      color: const Color(0xFFE2A9F1).withValues(alpha: 0.2),
                      blurRadius: 4,
              ...
              child: TextFormField(
                ...
                decoration: InputDecoration(
                  ...
                  focusedBorder: OutlineInputBorder(
                    borderRadius: BorderRadius.circular(8),
                    borderSide:
                        const BorderSide(color: Color(0xFFE2A9F1), width: 2),
                  ),
                  errorBorder: OutlineInputBorder(
                    borderRadius: BorderRadius.circular(8),
                    borderSide: const BorderSide(color: Colors.red),
