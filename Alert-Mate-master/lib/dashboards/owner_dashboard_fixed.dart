...
class _OwnerDashboardState extends State<OwnerDashboard> with TickerProviderStateMixin {
  ...
  void initState() {
    super.initState();
    // No need to init mock data or load vehicles manually
    // _vehicleService.initMockData(widget.user.id); // Optional: call if you want to seed data
    ...
    // _startDataUpdate(); // Disable random updates for now as we use real stream
  }
